...
<div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
    text-slate-700'>
      ...
      border-gray-200'>
       ...
       <p className= 'mt-6 text-sm font-medium'>Describe Objectname to be removed </p>

        <textarea onChange={(e)=>setObject(e.target.value)} value={object} rows={4}  className='w-full p-2 px-3 mt-2 outline-none text-sm
        rounded-md border border-gray-300' placeholder='e.g.,box or spoon,only single object name'required />
