  ...
  return (
    ...
    min-h-screen'>
        ...
        <div className='text-center mb-6'>
            <h1 className='text-3xl sm:text-5xl md:text-5xl md:text-6xl
            2xl:text-7xl font-semibold mx-auto leading-[1.2]'>Create amazing content <br />
             with <span className='text-blue-700'>AI tools</span> </h1>
        ...
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            <button onClick={()=> navigate('/ai')} className='bg-blue-700 text-white px-10 py-3 rounded-lg
            hover:scale-102 active;scale-95 transition cursor-pointer'>Start Creating Now</button>
            <button className='bg-white px-10 py-3rounded-lg border
